...
# Load and Compile OpenCL Kernels from .cl File
with open("kernels.cl", "r") as f:
    kernel_source = f.read()
program = cl.Program(ctx, kernel_source).build()

# Allocate Buffers (input, intermediate, output)
...
# Set Arguments and Enqueue Gaussian Blur Kernel (Kernel 1)
...
# Ensure Kernel 1 Completes Before Kernel 2 Starts
event1.wait()

# Set Arguments and Enqueue Tone Mapping Kernel (Kernel 2)
...
# Wait for Completion of Kernel 2
event2.wait()
queue.finish()

# Read Final Processed Image from GPU to CPU
